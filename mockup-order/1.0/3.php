						...
						<div class="container">
								...
								<form>
										<div class="products">
												...
												<div class="total">
														<span class="item-name">ค่าจัดส่ง</span>
										...
										<div class="card-details">
												<h3 class="title">เลือกรูปแบบการจัดส่ง</h3>
												<div class="row donate" id="donate1">
														<div class="form-group col-sm-12">
																<div class="payment-method">
																	<input class="form-check-input" type="radio" name="paymentmethod" id="paymentmethod-kerry" value="kerry" checked>
																	<label class="form-check-label" for="paymentmethod-kerry">
																		Kerry Express (เคอรี่ เอ็กซ์เพรส)
																	</label>
																	<span style="float: right;">฿100</span>
																</div>
																<div class="payment-method">
																	<input class="form-check-input" type="radio" name="paymentmethod" id="paymentmethod-thailandpost" value="ems">
																	<label class="form-check-label" for="paymentmethod-thailandpost">
																		EMS บริษัท ไปรษณีย์ไทย จำกัด ThailandPost
																	</label>
																	<span style="float: right;">฿150</span>
																</div>
																<div class="payment-method">
																	<input class="form-check-input" type="radio" name="paymentmethod" id="paymentmethod-pickup" value="pickup">
																	<label class="form-check-label" for="paymentmethod-pickup">
																		ลูกค้ามารับเอง 
																	</label>
												...
												<h3 class="title">เลือกช่องทางการชำระเงิน</h3>
												<div class="row donate" id="donate1">
														<div class="form-group col-sm-12">
																<div>
																	<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked>
																	<label class="form-check-label" for="exampleRadios1">
																		กสิกรไทย สำนักพิมพ์เลี่ยงเชียง สาขา บางมด 1213-13481-41
																	</label>
																</div>
																<div>
																	<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
																	<label class="form-check-label" for="exampleRadios2">
																		ไทยพานิชย์ สำนักพิมพ์เลี่ยงเชียง สาขา บางมด 1213-13481-41
																	</label>
																...
																<div>
																	...
																	<label class="form-check-label" for="exampleRadios3">
																		ทหารไทย สำนักพิมพ์เลี่ยงเชียง สาขา บางมด 1213-13481-41
																	</label>
												...
												<div class="row">
														...
														<div class="form-group col-sm-8">
																<button type="button" class="btn btn-primary btn-block">ขั้นตอนต่อไป</button>
														</div>
												</div>
										</div>
								</form>
...
<script type="text/javascript">
	...
	$(function() {
		$('.payment-method').click(function(event) {
			var html = $(this).find('.form-check-label').html();
			$('.total .item-name').html('ค่าจัดส่ง (' + html.trim() + ')');
		});
	});
